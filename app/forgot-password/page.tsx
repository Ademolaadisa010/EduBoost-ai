      ...
      <div className="min-h-screen lg:grid lg:grid-cols-2">
        ...
        <div className="relative hidden lg:flex flex-col justify-between overflow-hidden bg-slate-900 p-12 xl:p-16">
          ...
          <div className="relative z-10 my-auto">
            <p className="text-orange-400 font-bold uppercase tracking-widest text-xs mb-4">Password Recovery</p>
          ...
          <div className="relative z-10 rounded-2xl bg-white/5 border border-white/8 px-5 py-4">
            ...
            <p className="text-slate-300 text-sm font-medium leading-relaxed">
              Check your spam folder if the email doesn&apos;t arrive. The reset link expires in 1 hour for your security.
            </p>
          </div>
        </div>
          ...
          <div className="w-full max-w-md">
            ...
            {success ? (
              <div className="text-center">
                ...
                <h2 className="font-display font-black text-slate-900 text-3xl leading-tight mb-3">Check your inbox</h2>
                ...
                <p className="text-slate-400 text-xs font-medium mb-8">
                  ...
                  <button onClick={() => { setSuccess(false); setError(""); }}
                ...
                <div className="bg-teal-50 border-2 border-teal-200 rounded-2xl px-5 py-4 text-left mb-8">
                  ...
                  <p className="text-teal-600 text-sm font-medium leading-relaxed">
                    The reset link expires in <strong>1 hour</strong>. If it expires, just come back and request a new one.
                  </p>
                </div>
                <Link href="/sign-in"
              ...
              <>
                ...
                <div className="mt-8 space-y-3 text-center">
                  <p className="text-sm text-slate-500 font-medium">
                    ...
                    <Link href="/sign-in" className="font-black text-orange-500 hover:text-orange-600 transition">Sign in</Link>
                  </p>
                  <p className="text-sm text-slate-400 font-medium">
                    Don&apos;t have an account?{" "}
                    <Link href="/Register" className="font-black text-teal-600 hover:text-teal-700 transition">Sign up free</Link>
                  </p>
                </div>
              </>
            )}
