          ...
          {!hasResult && !loading && (
            <div className="bg-white border-2 border-slate-200 rounded-2xl p-10 text-center">
              ...
              <p className="text-slate-500 text-sm font-medium max-w-xs mx-auto">
                Paste your notes on the left and choose an action. Try the sample note if you&apos;re new!
              </p>
            </div>
          )}
          ...
          {loading && (
            <div ref={resultRef} className="bg-white border-2 border-slate-200 rounded-2xl p-6">
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  <p className="font-display font-bold text-slate-900 text-sm">AI is working…</p>
              ...
              <div className="bg-white border-2 border-teal-200 rounded-2xl p-5">
                <div className="flex items-center justify-between gap-3 mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div><p className="font-display font-bold text-slate-900 text-sm">Practice Questions</p><p className="text-xs text-slate-400 font-medium">{questions.length} questions — answer below</p></div>
                  </div>
                ...
                <div className="bg-amber-50 border-2 border-amber-200 rounded-xl px-4 py-2.5 flex items-start gap-2">
                  ...
                  <p className="text-amber-700 text-xs font-medium">Answer in your own words, then click &quot;Check&quot; for AI grading.</p>
                </div>
              </div>
